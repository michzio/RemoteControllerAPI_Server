...
int main(int argc, char **argv) {
    ...
    //char *message = "keyboard input: kVK_ANSI_T modifier flags: ";
    //char *message = "player: volume mute";
    //char *message = "system: volume level: 100";
    //char *message = "browser: new tab";
    //char *message = "shortcut: force quit";
    //handle_rpc_request(message, sizeof(message));
