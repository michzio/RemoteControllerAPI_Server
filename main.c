...
void on_server_start(sock_fd_t ps_fd, int server_port, const char *server_ip);
void on_server_end(void);
void on_server_error(sock_fd_t ps_fd, const int error_code, const char *error_msg);
void on_client_connected(sock_fd_t cs_fd, int client_port, const char *client_ip);
void on_client_disconnecting(sock_fd_t cs_fd, int client_port, const char *client_ip);
void on_connection_error(sock_fd_t cs_fd, const int error_code, const char *error_msg);
void on_datagram_error(sock_fd_t ps_fd, const int error_code, const char *error_msg);
